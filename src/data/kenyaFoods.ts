...
export const KENYAN_FOODS: Food[] = [
  // Staples
  { id: 'ugali', name: 'Ugali', category: 'staples', caloriesPerServing: 280, proteinG: 0, carbsG: 68, fatG: 1, servingDescription: '1 serving (200g)', servingGrams: 200 },
  { id: 'chapati', name: 'Chapati', category: 'staples', caloriesPerServing: 220, proteinG: 0, carbsG: 44, fatG: 5, servingDescription: '1 piece', servingGrams: 80 },
  { id: 'rice', name: 'Rice (cooked)', category: 'staples', caloriesPerServing: 200, proteinG: 0, carbsG: 48, fatG: 0, servingDescription: '1 cup (180g)', servingGrams: 180 },
  { id: 'mukimo', name: 'Mukimo', category: 'staples', caloriesPerServing: 260, proteinG: 0, carbsG: 54, fatG: 5, servingDescription: '1 serving (200g)', servingGrams: 200 },
  { id: 'mandazi', name: 'Mandazi', category: 'snacks', caloriesPerServing: 180, proteinG: 0, carbsG: 34, fatG: 7, servingDescription: '1 piece (60g)', servingGrams: 60 },
  ...
  // Vegetables
  { id: 'sukuma-wiki', name: 'Sukuma Wiki', category: 'veg', caloriesPerServing: 45, proteinG: 0, carbsG: 10, fatG: 1, servingDescription: '1 cup cooked', servingGrams: 120 },
  { id: 'cabbage', name: 'Cabbage (cooked)', category: 'veg', caloriesPerServing: 35, proteinG: 0, carbsG: 8, fatG: 0, servingDescription: '1 cup', servingGrams: 120 },
  { id: 'tomatoes', name: 'Tomatoes', category: 'veg', caloriesPerServing: 20, proteinG: 0, carbsG: 5, fatG: 0, servingDescription: '2 medium', servingGrams: 120 },
  { id: 'spinach', name: 'Spinach (cooked)', category: 'veg', caloriesPerServing: 40, proteinG: 0, carbsG: 9, fatG: 0, servingDescription: '1 cup', servingGrams: 100 },
  ...
  // Drinks
  { id: 'uji', name: 'Uji (porridge)', category: 'drinks', caloriesPerServing: 120, proteinG: 0, carbsG: 28, fatG: 1, servingDescription: '1 cup (240ml)', servingGrams: 240 },
